...
var/global/list/ROLES_LOWPOP_CIC = list(JOB_LP_CO, JOB_LP_SO, JOB_LP_PCDR, JOB_LP_PSGT)
var/global/list/ROLES_LOWPOP_REQUISITION = list(JOB_LP_CARGO_TECH)
var/global/list/ROLES_LOWPOP_MEDICAL = list(JOB_LP_DOCTOR)
var/global/list/ROLES_LOWPOP_MARINES = list(JOB_LP_SQUAD_LEADER, JOB_LP_SQUAD_MEDIC, JOB_LP_SQUAD_SMARTGUN, JOB_LP_SQUAD_ENGI, JOB_LP_SQUAD_MARINE)
...
var/global/list/ROLES_LOWPOP_USCM = ROLES_LOWPOP_CIC + ROLES_LOWPOP_REQUISITION + ROLES_LOWPOP_MEDICAL + ROLES_LOWPOP_MARINES
var/global/list/ROLES_GROUND = ROLES_XENO + ROLES_SPECIAL + ROLES_WHITELISTED

var/global/list/ROLES_DISTRESS_SIGNAL = ROLES_LOWPOP_USCM + ROLES_GROUND
