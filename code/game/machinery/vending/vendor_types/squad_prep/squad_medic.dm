...
GLOBAL_LIST_INIT(cm_vending_gear_medic, list(
		...
		list("M3 B12 Pattern Marine Armor", 28, /obj/item/clothing/suit/marine/leader, null, VENDOR_ITEM_REGULAR),
		list("M4 Pattern Armor", 28, /obj/item/clothing/suit/marine/rto, null, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/gear/medic
	...
	icon_state = "med_gear"
	show_points = TRUE
	vendor_role = list(JOB_SQUAD_MEDIC, JOB_LP_SQUAD_MEDIC)
...
GLOBAL_LIST_INIT(cm_vending_clothing_medic, list(
		...
		list("Standard Armor", 0, /obj/item/clothing/suit/marine/medium, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_RECOMMENDED),
